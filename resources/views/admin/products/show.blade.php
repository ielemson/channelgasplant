                    ...
                    <div class="widget-content widget-content-area" style="height: 571px;">
                                ...
                                <div class="form-row mb-4">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  class="form-control form-icon-input-left @error('name') is-invalid @enderror" id="name" type="text" name="name" placeholder="enter product name" required value="{{$product->name }}" disabled/>
                                @error('name')
                            ...
                            @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input  class="form-control form-icon-input-left @error('price') is-invalid @enderror" id="price" type="text" name="price" placeholder="enter product price" required value="{{ $product->price }}" disabled/>
                                        @error('price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-row mb-4">
                                    ...
                                    <input  class="form-control form-icon-input-left @error('size') is-invalid @enderror" id="size" type="text" name="size" placeholder="enter cylinder size" required value="{{ $product->size }}" disabled/>
                                @error('size')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            @enderror 
                                ...
                                <div class="form-row mb-4">
                                        ...
                                        <textarea class="form-control form-icon-input-left" placeholder="enter product details" name="detail" disabled rows="5">{{ $product->detail }}</textarea>
