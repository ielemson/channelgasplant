@extends('layouts.adminApp',['title'=>'Admin Dashboard | Create Role'])
...
<div id="content" class="main-content">
    <div class="layout-px-spacing">
           ...
           {{-- INCLUDE PAGE HEADER --}}
           @include('admin.includes.header',['headerTitle'=>'Roles','title1'=>'Roles','title2'=>'Create'])
           {{-- INCLUDE PAGE HEADER --}}
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <span class="form-icon-wrapper">
                                                    ...
                                                    <input
                                                        ...
                                                        id="confirm-password" type="text" name="name"
